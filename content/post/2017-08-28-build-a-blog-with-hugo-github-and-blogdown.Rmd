...
You should have Git CMD istalled with the Git installation:
...
It is the configuration of the blog[^6].
...
blogdown::serve_site()
```
Now you should see a local version of your blog in RStudio. You should be able to display it on your browser with the button "Show in new window".[^7]
...
[^6]: The picture of this config.toml file is just illustrative and it is taken from another tamplate (theme).
[^7]: There should be a button,`Serve Site`, in RStudio for the function `blogdown::serve_site()`, in the Addins menu.
