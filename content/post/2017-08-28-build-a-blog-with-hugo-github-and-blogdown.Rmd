...
summary: "The installation guide to use Hugo and blogdown to build blog or sites in RStudio. Blogdown is a package that uses Hugo, a static site generator and supports Markdown and Rmarkdown files. The blog can be hosted for free on Github or Netlify."
