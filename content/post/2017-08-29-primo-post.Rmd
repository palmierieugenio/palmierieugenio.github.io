...
I want to describe with some exampes the main feautures of the blog, expecially for other statistics or other R (a programming language) users like me. In my next post I am going to explain how to [build a blog like this for free](https://palmierieugenio.github.io/post/build-a-blog-with-hugo-github-and-blogdown/).

I don't plan to make all my posts about programming or *topics for nerd*, I want to make more accessible contents in the future, but, for now, if you aren't into this kind of things, I warn you that you eyes could bleed.
