...
## Hello World, welcome to Computation Debate,

My name is Eugenio Palmieri and I'm starting a new personal blog, *Computation Debate*[^1]. I'm a Master's student in Statistics at Florence University (Italy) and I want to write mainly about statistics, informatics and programming[^2], but I'm interested also in economics, politics, urban planning, mathematics and other nerdy topics.

## Feautures of the blog:

### Integration with R:
One of the main feauture of this blog is that it supports [Rmarkdown](http://rmarkdown.rstudio.com/) files, which make it possible to create post from Rstudio to generate directly graphs, tables and interactive [html widgets](http://www.htmlwidgets.org/) with R[^3], like in this graph example:
